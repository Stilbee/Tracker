...
final class StatisticCell: UITableViewCell {
    ...
    private let gradientLayer: CAGradientLayer = {
        ...
        gradientLayer.colors = [UIColor.ypStatisticGradient1.cgColor, UIColor.ypStatisticGradient2.cgColor, UIColor.ypStatisticGradient3.cgColor]
    ...
    private let insideView: UIView = {
        ...
        insideView.backgroundColor = .ypBackgroundLight
